...
void HLTInfo::analyze(const edm::Handle<edm::TriggerResults>                 & hltresults,
  ...
  if (hltresults.isValid()) {
    ...
    //triggerEventTag_ = (edm::InputTag)("hltTriggerSummaryAOD","","HLT_WX"); //.. process name HLT_WX
...
//		  cout << "im =========" << im << endl;
//		  cout << "filterIndex ==== " << filterIndex << " size of filters:  " << triggerEventHandle_->sizeFilters() << endl;
          if (filterIndex<triggerEventHandle_->sizeFilters())  
			  lastfilter = im;
	  }
...
//	  cout << "trigger decision : " << trigflag[itrig] << endl;
